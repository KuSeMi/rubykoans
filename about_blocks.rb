...
class AboutBlocks < Neo::Koan
  ...
  # https://www.youtube.com/watch?v=B9NMSNMmvdc
  # https://www.youtube.com/watch?v=YXMsry5Ybcs&t=1173s  Russian
  ...
  # ------------------------------------------------------------------
  # https://ru.hexlet.io/courses/ruby/lessons/blocks/theory_unit
