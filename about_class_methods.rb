...
class AboutClassMethods < Neo::Koan
  ...
  def test_other_objects_are_not_affected_by_these_singleton_methods
    ...
    # Метод wag был добавлен только к экземпляру fido собаки
    # класс. Экземпляру ровера не дали этот метод.
  ...
  # Не только каждый метод в Ruby возвращает значение (и не только
  # класс), но каждая выполняемая строка имеет возвращаемое значение.
  ...
  class Dog
    # со ссылкой на test_you_can_define_class_methods_inside_the_class
    # вы можете написать метод класса таким же образом, используя "self". на месте
    # имени класса
